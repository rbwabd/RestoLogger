if Rails.env == "production"
	Rails.application.config.middleware.use OmniAuth::Builder do
		...
		Rails.application.config.middleware.use OmniAuth::Builder do
			...
			provider :facebook, '	242516295838836', '	5eea597f7b47e15da107328196f8e047', {:scope => 'publish_stream,offline_access,email'} # Find these values on the Facebook App page
		end
	#end
end